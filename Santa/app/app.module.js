...
AppModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [app_component_1.AppComponent, home_component_1.HomeComponent, elves_compoment_1.ElvesComponent],
        providers: [{ provide: common_1.APP_BASE_HREF, useValue: '/' }, elves_service_1.ElfService],
